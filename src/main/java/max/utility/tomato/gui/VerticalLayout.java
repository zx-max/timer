...
public class VerticalLayout implements LayoutManager {
	...
	private final int alignment; // LEFT, RIGHT, CENTER or BOTH...how the
									// components are justified
	private final int anchor; // TOP, BOTTOM or CENTER ...where are the
								// components positioned in an overlarge space
	private final int vgap; // the vertical vgap between components...defaults
							// to 5
