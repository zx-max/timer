...
public class StartTimerWindow extends JFrame {
    ...
    private void storeDataAndStartTimer() {
        ...
        sb.append((new LocalDateTime()).toString("dd/MM/yyyy HH:mm")).append("\n");
        sb.append(I18N.getKey(this.getClass(), TIMER_LOGGER_TITOLO)).append(tomato.getTitle()).append("\n");
        sb.append(I18N.getKey(this.getClass(), TIMER_LOGGER_FOCUS_ON)).append(tomato.getFocusOn());
