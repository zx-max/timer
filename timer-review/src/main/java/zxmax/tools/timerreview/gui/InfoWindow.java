...
public class InfoWindow extends JFrame {
    ...
    private void initComponents() {
        ...
        setResizable(false);
        setTitle(I18N.getKey(getClass(), "window.title"));
    ...
    private void addApplicationVersionToContentPane(String row) {
        ...
        ApplicationInfo ai = (ApplicationInfo) Register.get(ApplicationInfo.class);
        txtApplicationVersion.setText(ai.getImplementationVersion());

        contentPane.add(lblApplicationVersion, "cell 0 " + row + ",alignx left,aligny baseline");
        contentPane.add(txtApplicationVersion, "cell 1 " + row + ",growx,aligny baseline");
    }
    ...
    private void addApplicationLogFilePathToContentPane(String row) {
        ...
        contentPane.add(lblApplicationLog, "cell 0 " + row + ",alignx left,aligny baseline");
        contentPane.add(txtApplicationLog, "cell 1 " + row + ",growx,aligny baseline");
    ...
    private void addReportFilePathToContentPane(String row) {
        ...
        contentPane.add(lblTimerLog, "cell 0 " + row + ",alignx left,aligny baseline");
        contentPane.add(txtTimerLog, "cell 1 " + row + ",growx,aligny baseline");

    }

    private void addSourceForgeToContentPane(String row) {
        lblSourceforge = new JLabel("sourceforge");
        contentPane.add(lblSourceforge, "cell 0 " + row + ",alignx left,aligny baseline");
        ...
        contentPane.add(txtSourceForgeLink,
                "cell 1 " + row + ",growx,aligny baseline");
        txtSourceForgeLink.setColumns(10);
    }

    private void addSoftPediaToContenPane(String row) {
        lblSoftpedia = new JLabel("softpedia:");
        contentPane.add(lblSoftpedia, "cell 0 " + row + ",alignx left,aligny baseline");
    ...
    private void addWebAddressToContenPane(String row) {
        lblWebAddress = new JLabel(I18N.getKey(getClass(), "web"));
        contentPane.add(lblWebAddress, "cell 0 " + row + ",alignx left,aligny baseline");
        ...
        contentPane.add(txtWebAddress,
                "cell 1 " + row + ",growx,aligny baseline");
        txtWebAddress.setColumns(10);
    }

    private void addEmailToContentPane(String row) {
        JLabel lblEmail = new JLabel(I18N.getKey(getClass(), "mail"));
        contentPane.add(lblEmail, "cell 0 " + row + ",alignx left,aligny baseline");

        txtAuthorEmail = new JTextField();
        txtAuthorEmail.setEditable(false);
        txtAuthorEmail
                .setText("massimiliano.parentini@gmail.com");
        contentPane.add(txtAuthorEmail,
                "cell 1 " + row + ",growx,aligny baseline");
        txtAuthorEmail.setColumns(10);
    }

    private void addAuthorNameToContentPane(String row) {
        JLabel lblAuthorName = new JLabel(I18N.getKey(getClass(), "author"));
        contentPane.add(lblAuthorName, "cell 0 " + row + ",alignx left,aligny baseline");
